...
export class EnterpriseService {
  ...
  newEnterprise(body: EnterpriseRequest, economicActivity: number, manager: number): Observable<MessageResponse<EnterpriseClass>> {
    let params = new HttpParams();
  ...
  setEnterprise(id: number, name: string): void {
